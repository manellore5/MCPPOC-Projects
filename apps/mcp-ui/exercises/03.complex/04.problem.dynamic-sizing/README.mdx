...
<EpicVideo url="https://www.epicai.pro/workshops/mcp-ui-aubv9/dynamic-sizing-rxiyf" />
...
<callout-warning>
  Just make sure you utilize scrolled elements to avoid requesting a ton of height or width with a
  lot of content.
</callout-warning>
...
<callout-info>
  Measure after the component renders to get accurate dimensions. This typically happens so fast the
  user won't notice.
</callout-info>
