...
<EpicVideo url="https://www.epicai.pro/workshops/mcp-ui-aubv9/break-to-complex-9bauc" />
...
<callout-success>
  The key improvement is that your UI components now have access to the full ecosystem of web
  technologies while maintaining secure communication with the host application through the
