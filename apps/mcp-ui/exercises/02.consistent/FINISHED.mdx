...
<callout-success>
  The key improvement is that your UI components now automatically inherit the host application's
  design system, creating a consistent and professional experience that feels native to whatever
  application your users are using.
</callout-success>
