...
export const createEntryInputSchema = {
  ...
  tags: z.array(z.number()).optional().describe("The IDs of the tags to add to the entry"),
};
...
export const updateTagInputSchema = {
  id: z.number(),
  ...Object.fromEntries(
    Object.entries(createTagInputSchema).map(([key, value]) => [key, value.nullable().optional()]),
  ),
};
