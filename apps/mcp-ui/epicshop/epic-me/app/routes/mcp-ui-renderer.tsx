...
import { UIResourceRenderer, type UIActionResult, isUIResource } from "@mcp-ui/client";
...
export async function clientLoader({ request }: Route.LoaderArgs) {
  ...
  if (!isUIResource(content)) {
    throw new Error(`resourceData param must be a UI resource. Instead it is: ${resourceData}`);
  }
...
export default function MCPRenderer({ loaderData }: Route.ComponentProps) {
      ...
      if (iframeRef.current && event.source === iframeRef.current.contentWindow) {
        try {
          ...
          const isUIActionMessage =
            ...
            messageData.type &&
            ["tool", "prompt", "link", "intent", "notify"].includes(messageData.type);
  ...
  const sendMessage = () => {
    ...
    if (selectedMessageId && pendingPromisesRef.current.has(selectedMessageId)) {
            ...
            <div className="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
              ...
              <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-700">
                ...
                {content.resource.contentType && (
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    <strong>Content Type:</strong> {content.resource.contentType}
                  </p>
                )}
              </div>
              ...
              {isUIResource(content) ? (
                ...
                <div className="flex h-[600px] items-center justify-center rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-700">
                  <p className="text-gray-500 dark:text-gray-400">Unsupported resource type</p>
                </div>
              )}
            </div>
          </section>
            ...
            <div className="flex flex-1 flex-col rounded-xl bg-white shadow-lg dark:bg-gray-800">
              ...
              <div className="flex flex-1 flex-col">
                          ...
                          <div className="mb-1 flex items-center justify-between gap-1">
                            <div className="flex items-center gap-2">
                              ...
                              {needsResponse(message.messageId) && (
                                ...
                                >
                                  {selectedMessageId === message.messageId ? "Selected" : "Respond"}
                                </button>
                              )}
                            </div>
                            <span
                ...
                <div className="border-t border-gray-200 p-4 dark:border-gray-700">
                  ...
                  <div id="message-help" className="mt-1 text-xs text-gray-500 dark:text-gray-400">
...
function MessageTypeLabel({
  ...
  if (type === "received" && content.includes('"type":')) {
    try {
      ...
      const emoji = ACTION_EMOJIS[parsed.type as keyof typeof ACTION_EMOJIS] || "📨";
      return (
        <>
  ...
  if (isRouteErrorResponse(error)) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 p-8 dark:from-gray-900 dark:to-gray-800">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
            ...
            <p className="text-sm text-red-600 dark:text-red-400">{error.data}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 p-8 dark:from-gray-900 dark:to-gray-800">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
            ...
            <p className="mb-4 text-sm text-red-600 dark:text-red-400">{error.message}</p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 p-8 dark:from-gray-900 dark:to-gray-800">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
            <h1 className="text-2xl font-bold text-red-600 dark:text-red-400">Unknown Error</h1>
          </div>
        </div>
      </div>
    );
