...
export async function action({ request, context }: Route.ActionArgs) {
  ...
  try {
    ...
    const requestParams = requestParamsSchema.parse(Object.fromEntries(url.searchParams));

    const { redirectTo } = await context.cloudflare.env.OAUTH_PROVIDER.completeAuthorization({
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                  <p>
                    This authorization will grant the requesting application access to your Epic Me
                    data. Please select the user account you want to authorize.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                  <p className="mb-3">
                    Normally, you would be automatically redirected to complete the OAuth flow.
                    Since this is a demo environment, please click the link below to continue:
                  </p>
                  <a
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  The OAuth response type (e.g., "code" for authorization code flow)
                </p>
                <input
                  type="text"
                  id="response_type"
              ...
              <div>
                ...
                <input
                  ...
                  defaultValue={searchParams.get("code_challenge_method") ?? undefined}
                  className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-blue-400 dark:focus:ring-blue-400"
                />
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Optional parameter to maintain state between request and callback
                </p>
                <input
                  type="text"
                  id="state"
